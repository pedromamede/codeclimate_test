...
class VendasControllerTest < ActionController::TestCase
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post :create, venda: { produto_id: @venda.produto_id, quantidade: @venda.quantidade, valor_unitario: @venda.valor_unitario }
    end
  ...
  test "should update venda" do
    patch :update, id: @venda, venda: { produto_id: @venda.produto_id, quantidade: @venda.quantidade, valor_unitario: @venda.valor_unitario }
    assert_redirected_to venda_path(assigns(:venda))
  end
